...
- [ ] Implementar banco de dados próprio;
- [ ] Melhorar o gerenciamento do token da API;
- [ ] Implementar renovação automática do token;
- [ ] Expandir os dados municipais;
- [ ] Adicionar informações de serviços públicos;
...
O projeto busca transformar dados públicos e informações provenientes de diferentes fontes em informações mais acessíveis para o cidadão.

A ideia é que o usuário não precise conhecer APIs, bancos de dados ou sistemas governamentais para conseguir entender o que está acontecendo em sua cidade.

> **Informação pública deve ser acessível, compreensível e útil para a população.**
...
[@ryancpsilva](https://github.com/ryancpsilva?utm_source=chatgpt.com)

---

## 📄 Licença

Este projeto está atualmente distribuído sob a licença **ISC**, conforme definido no `package.json`.